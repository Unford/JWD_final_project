...
<head>
    ...
    <link href="https://cdnjs.cloudflare.com/ajax/libs/flag-icon-css/4.1.5/css/flag-icons.min.css" rel="stylesheet"
          type="text/css">
    <link rel="stylesheet" href="${pageContext.request.contextPath}/css/error_500.css">
</head>
...
<main class="text-center ">
    <div class="main-error-page">
        ...
        <h1 class="error-title">
            <fmt:message key="error.500.oops" bundle="${lang}"/>! <br><fmt:message key="error.500.description" bundle="${lang}"/> :(
        </h1>
