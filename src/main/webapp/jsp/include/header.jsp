        ...
        <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
            ...
            <form class="col-12 col-lg-auto mb-3 mb-lg-0 me-lg-3">
                <input type="search" class="form-control"
                       placeholder="<fmt:message key="header.search" bundle="${lang}"/>..." aria-label="Search">
            </form>
                ...
                <c:when test="${sessionScope.user.role != 'GUEST'}">
                    <div class="dropdown text-end">
                        ...
                        <ul class="dropdown-menu text-small" aria-labelledby="dropdownUser1" style="">
                            <li><a class="dropdown-item" href="${pageContext.request.contextPath}/controller?command=show_profile">
