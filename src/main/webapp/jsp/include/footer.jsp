        ...
        <ul class="nav justify-content-center border-bottom pb-1 mb-1">
            ...
            <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="dropdown08">
                    <li><a class="dropdown-item <c:if test="${sessionScope.locale eq 'en'}">active</c:if>" href="#"><span class="flag-icon flag-icon-us me-2"></span><fmt:message key="header.language.eng" bundle="${lang}"/></a></li>
                    <li><a class="dropdown-item <c:if test="${sessionScope.locale eq 'ru'}">active</c:if>" href="#"><span class="flag-icon flag-icon-ru me-2"></span><fmt:message key="header.language.ru" bundle="${lang}"/></a></li>
                </ul>
            </li>
        </ul>
