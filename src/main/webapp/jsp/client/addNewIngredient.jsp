...
<main>
    ...
    <form class="container g-3 needs-validation justify-content-center " novalidate
                ...
                <div class="row row-cols-1">
                        ...
                        <select id="measure" class="form-select form-select-sm form-control"
                            ...
                            <c:forEach items="${requestScope.measures}" var="measure">
                                <option value="${measure.id}"
                                        <c:if test="${measure.id eq requestScope.parameters.measure}">selected</c:if>>
                                        ${measure.name}</option>
                    ...
                    <div class="col ">
                        ...
                        <div class="input-group">
                            ...
                            <input id="price" type="number" name="price" class="form-control" required min="0"
                                   max="1000" step="0.01"
                                   <c:if test="${not empty requestScope.parameters.price}">value="${requestScope.parameters.price}" </c:if>>
                    ...
                    <div class="col ">
                        ...
                        <input id="calorie" type="number" name="calorie" class="form-control" required min="1" step="1"
                               max="2000"
                               <c:if test="${not empty requestScope.parameters.calorie}">value="${requestScope.parameters.calorie}" </c:if>>
        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                ...
                <input id="name" type="text" name="name" class="form-control" required
                       value="${requestScope.parameters.name}">
        ...
        <div class="row justify-content-center">
            <div class="col-md-8 ">
                ...
                <textarea class="form-control" data-mdb-showcounter="true"
                          ...
                          required>${requestScope.parameters.description}</textarea>
        ...
        <c:if test="${not empty requestScope.parameters}">
            <div class="row justify-content-center mt-2">
                <div class="col-8">
                    <div class="alert alert-danger alert-dismissible fade show" role="alert">
                        <fmt:message key="addNewIngredient.alert" bundle="${lang}"/>
