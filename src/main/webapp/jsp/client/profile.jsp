                    ...
                    <c:if test="${sessionScope.user.id != requestScope.user.id}">
                        <div class="container">
                                <c:choose>
                                    ...
                                    <c:when test="${requestScope.user.reviews.contains(0)}"><!--todo-->
                                    ...
                                    <c:otherwise>
                                        <c:if test="${not requestScope.user.deleted}">
                                            <form class=" g-3 needs-validation justify-content-center " novalidate action="${pageContext.request.contextPath}/controller" method="post">
